...
@Component({
  ...
  template: `
    <div style="display: flex; justify-content: space-between; align-items: center; width: 100%; margin-bottom: 1.5rem;">
      <h3 style="margin: 0; font-size: 1.5rem; font-weight: 600;">Teams Management</h3>
      ...
      <div class="card-body p-3">
        <div style="display: flex; justify-content: space-between; flex-wrap: wrap; gap: 16px; align-items: center;">
          ...
          <div style="flex: 1; max-width: 400px; min-width: 250px; position: relative;">
            ...
            <input type="text" class="form-control" placeholder="Search employee..." [(ngModel)]="searchTerm" style="padding-left: 40px; height: 42px; width: 100%; border: 1px solid #cbd5e1; border-radius: 8px; background-color: #f8fafc; color: #334155; outline: none;">
          </div>
      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr *ngIf="filteredTeams.length === 0">
            <td colspan="6" class="text-center text-muted py-4">No employees found matching the filters.</td>
          </tr>
        </tbody>
      </table>
    </div>
    ...
    <div class="modal-backdrop" *ngIf="showTeamModal">
      <div class="modal-content" style="max-width: 600px;">
        <h4 style="margin-top: 0; margin-bottom: 24px; font-weight: 600;">{{ currentTeam.id ? 'Edit Employee' : 'Add Employee' }}</h4>
        ...
        <div style="margin-bottom: 16px;">
          <label style="display: block; margin-bottom: 8px; font-weight: 500; font-size: 0.9rem;">Employee Name</label>
        ...
        <div style="display: flex; justify-content: flex-end; gap: 12px; margin-top: 16px; padding-top: 16px; border-top: 1px solid #e2e8f0;">
          ...
          <button class="btn btn-primary" (click)="saveTeam()" style="padding: 10px 20px; border-radius: 8px; font-weight: 500;">Save Employee</button>
        </div>
      </div>
    </div>
  `,
...
export class TeamsManagementComponent implements OnInit {
  ...
  branches: any[] = [];
  departments: any[] = [];
  currentTeam: any = { branch_id: '', department_id: '', name: '', email: '', password: '', role: 'agent', is_active: true };
  ...
  openTeamModal() { 
    this.currentTeam = { branch_id: '', department_id: '', name: '', email: '', password: '', role: 'agent', is_active: true }; 
    this.showTeamModal = true; 
  }

  editTeamModal(team: any) {
    this.currentTeam = { ...team, password: '' };
    this.showTeamModal = true;
  }
