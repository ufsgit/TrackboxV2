...
export const routes: Routes = [
  ...
  { path: 'register', component: RegisterComponent },
  {
    ...
    children: [
      ...
      { path: 'lead/leave-request', loadComponent: () => import('./features/leave-request/leave-request.component').then(m => m.LeaveRequestComponent) },
      { path: 'crm/leave-request', loadComponent: () => import('./features/leave-request/leave-request.component').then(m => m.LeaveRequestComponent) },
      ...
      { path: 'system-settings/designation', loadComponent: () => import('./features/system-settings/components/designation-management/designation-management.component').then(m => m.DesignationManagementComponent), data: { roles: ['admin', 'superadmin'] } },
      { path: 'system-settings/intakes', loadComponent: () => import('./features/system-settings/components/intake-management/intake-management.component').then(m => m.IntakeManagementComponent), data: { roles: ['admin', 'superadmin'] } },
